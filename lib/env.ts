...
const envSchema = z.object({
  // One model handles drafting/intake/angles/critique *and* transcription -
  // Gemini's multimodal models accept inline audio directly, so there is no
  // separate transcription-model variable the way the OpenAI build needed
  // one for Whisper.
